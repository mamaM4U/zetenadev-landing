...
export const metadata: Metadata = {
  title: "Zetenadev | Design & Development Studio",
  description: "Grow your business with Zetenadev, a design & development studio.",
  openGraph: {
    images: [
      {
...
// ToDo: Replace Image with Zetenadev Logo
